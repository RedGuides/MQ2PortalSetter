...
#include "ISXEQPortalSetter.h"

// The mandatory pre-setup function.  Our name is "ISXEQPortalSetter", and the class is ISXEQPortalSetter.
...
// our instanced class.
ISXPreSetup("ISXEQPortalSetter", ISXEQPortalSetter);
...
unsigned int ISXEQPortalSetterXML = 0;
...
bool ISXEQPortalSetter::Initialize(ISInterface *p_ISInterface)
{
	...
	WriteChatf("ISXEQPortalSetter Loaded");
	return true;
}

// shutdown sequence
void ISXEQPortalSetter::Shutdown()
{
	// save settings, if you changed them and want to save them now.  You should normally save
	// changes immediately.
	//pISInterface->ExportSet(ISXEQPortalSetterXML,XMLFileName);

	pISInterface->UnloadSet(ISXEQPortalSetterXML);
...
void ISXEQPortalSetter::ConnectServices()
{
...
void ISXEQPortalSetter::RegisterCommands()
{
	// add any commands
...
void ISXEQPortalSetter::RegisterAliases()
{
	// add any aliases
}

void ISXEQPortalSetter::RegisterDataTypes()
{
	// add any datatypes
	// pMyType = new MyType;
...
void ISXEQPortalSetter::UnRegisterCommands()
{
	// remove commands
	//    pISInterface->RemoveCommand("MyCommand");
}
void ISXEQPortalSetter::UnRegisterAliases()
{
	// remove aliases
}
void ISXEQPortalSetter::UnRegisterDataTypes()
{
	// remove data types
	//if (pMyType)
	//{
...
void ISXEQPortalSetter::UnRegisterTopLevelObjects()
{
	// remove Top-Level Objects
	//    pISInterface->RemoveTopLevelObject("MapSpawn");
}
void ISXEQPortalSetter::UnRegisterServices()
{
	// shutdown our own services
	//    if (hISXEQPortalSetterService)
	//        pISInterface->ShutdownService(this,hISXEQPortalSetterService);
}

void ISXEQPortalSetter::LoadSettings()
{
	bool bChanged = false;

	// open the settings file, and store the ID number in ISXEQPortalSetterXML
	ISXEQPortalSetterXML = pISInterface->OpenSettings(XMLFileName);
	...
	Any set can be referred to by its ID.  The base set is stored in ISXEQPortalSetterXML.  Note that the settings
	...
	*/
	...
	if (unsigned int GeneralGUID = pISInterface->FindSet(ISXEQPortalSetterXML, "General"))
	{
